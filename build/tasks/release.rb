...
class MyApp
  class Release
    ...
    def task
      ...
      version = MyApp.instance.get_release_version

      packages = Array.new

      release = create_or_get_release version

      full_package = MyApp::Release::ReleasePackage.new
      full_package.version = version
      full_package.release_id = release.id
      full_package.file_name = MyApp.instance.get_archive_name
      full_package.file_path = MyApp.instance.get_archive_path
